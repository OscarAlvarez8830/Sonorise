    ...
    <main className="LandingPage">
      <section className="LandingPage__section">
        ...
        <nav className="LandingPage__nav">
          <Link className="LandingPage__link LandingPage__link--green-and-white" to="/sign-up">SIGN UP</Link>
          ...
          <Link className="LandingPage__link LandingPage__link--white-and-black" to="/login">LOGIN</Link>
        </nav>
      </section>
